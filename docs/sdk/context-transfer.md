---
sidebar_position: 3
title: Context Transfer Engine
description: SDK reference for the CLIO Transfer Engine (CTE) — distributed storage middleware for blob storage, multi-target management, and performance monitoring.
---
